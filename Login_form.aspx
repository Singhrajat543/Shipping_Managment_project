<%@ Page Language="C#" AutoEventWireup="true" Codefile="Login_form.aspx.cs" Inherits="WebApplication1.Login_form" %>
                                                            ...
                                                            <div class="well well-lg">
                                                                <div class="row">
                                                                    <div class="col-xs-8 col-md-12 col-sm-12">
                                                                        <label>NAME</label>
                                                                        <asp:TextBox ID="TextUserName" runat="server" placeholder="NAME" autofocus="" CssClass="form-control input-sm"></asp:TextBox>
                                                               ...
                                                               <div class="row">
                                                                ...
                                                                <asp:Button ID="Btnregsub" runat="server" class="btn btn-success" Text="SUBMIT" OnClick="Btnregsub_Click"  ValidationGroup="2" />&nbsp&nbsp
